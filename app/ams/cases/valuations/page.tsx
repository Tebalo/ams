...
export default async function Cases() {
  const result = await getCasesByStatus('Valuation')
    ...
    <>
      ...
      <div className="hidden h-full flex-1 flex-col space-y-2 p-2 md:flex">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Valuations</h2>
            <p className="text-muted-foreground">
              Here&apos;s a list of asset cases that are in the valuation stage!
            </p>
          </div>
